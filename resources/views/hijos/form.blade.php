<div class="form-group">
  ...
  <input type="text" name="nombreh" class="form-control" placeholder="Nombre completo" ng-model="hijo.nombre" mayus ng-required="hijosform">
</div>
<div class="row">
  <!--
...
-->
  ...
  <div class="form-group col-md-4">
    ...
    <div class="input-group date" id="fhijo">
      <input type="text" name="fecha_nac"  class="form-control mayus" placeholder="aaaa/mm/dd" ng-model="hijo.fecha_nac"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
    </div>
  </div>
